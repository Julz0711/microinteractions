...
export const IosPickerItem: React.FC<PropType> = (props) => {
  ...
  return (
    <div className="picker__ios-picker">
      <div className="picker__ios-picker__scene" ref={rootNodeRef}>
        <div
          className={`picker__ios-picker__viewport picker__ios-picker__viewport--perspective-${perspective}`}
          ref={emblaRef}
        >
          <div className="picker__ios-picker__container">
            {slides.map((_, index) => (
              <div className="picker__ios-picker__slide" key={index}>
                {index}
              </div>
            ))}
          </div>
